...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210180758/Untitled-design-(28).png"
    ...
    <table class="display" id = "list">
                            ...
                            // LMS.record where Date_of_Return is NULL and return.BookId=book.BookId and
                            //  return.BookId=record.BookId and return.RollNo=record.RollNo";
                        ...
                        $sql = "SELECT return.BookId, return.RollNo, Textbook, record.Dues,record.Date_of_Issue,  record.Due_Date, GREATEST(DATEDIFF(NOW(), record.Due_Date), 0) as x
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <?php
                                        if ($dues > 0) {
                                            echo "<a href='../staff/payment.php'class='button2' style='color:white'>Pending"; // Disable the return button for books with dues
                                        } else {
